...
import '../../../profile/presentation/widgets/placeholder_image.dart';
                                        ...
                                        child: IconButton(
                                          ...
                                          onPressed: () async {
                                            ...
                                            isUpdated = await context.push(
                                              '${AppRoutes.driverProfile}${AppRoutes.editProfile}',
                                            );
                                            if (mounted) {
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        ListTile(
                          ...
                          onTap: () {
                            context.push(
                              '${AppRoutes.driverProfile}${AppRoutes.changePassword}',
                            );
                          },
                        ),
                        ListTile(
                        ...
                        ListTile(
                          ...
                          onTap: () {
                            context.push(
                              '${AppRoutes.driverProfile}${AppRoutes.about}',
                            );
                          },
                        ),
                        ListTile(
                          ...
                          onTap: () {
                            context.push(
                              '${AppRoutes.driverProfile}${AppRoutes.faq}',
                            );
                          },
                        ),
                        ListTile(
                          ...
                          onTap: () {
                            context.push(
                              '${AppRoutes.driverProfile}${AppRoutes.termsAndConditions}',
                            );
                          },
                        ),
                        Divider(),
